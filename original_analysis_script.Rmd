---
title: "Analysis Code for *A Bayesian Meta-Analysis of the Acoustic Properties of Infant-Directed Speech* "
author: "Chris Cox (chris.mm.cox@gmail.com)"
date: "08/08/2022"
output:
  pdf_document:
    toc: true
...
project_data_list <- osf_ls_files(project_models_list[8,])
osf_download(project_data_list)
...
```{r}
data_F0_multiple_final <- readRDS("data_F0_multiple_final.RData")
data_F0_final <- readRDS("data_F0_final.RData")
...
F0_intercept_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors,
    file = here("models","F0_intercept_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
```{r}
data_VSA_multiple_final <- readRDS("data_VSA_multiple_final.RData")
data_VSA_final <- readRDS("data_VSA_final.RData")
...
VSA_intercept_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors,
    file = here("models", "VSA_intercept_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
```{r}
data_AR_multiple_final <- readRDS("data_AR_multiple_final.RData")
data_AR_final <- readRDS("data_AR_final.RData")
...
AR_intercept_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors,
    file = here("models", "AR_intercept_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
```{r}
data_VD_multiple_final <- readRDS("data_VD_multiple_final.RData")
data_VD_final <- readRDS("data_VD_final.RData")
...
VD_intercept_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors,
    file = here("models", "VD_intercept_m"),
    sample_prior = T,
    iter = 10000, 
    warmup = 500,
    cores = cores,
...
```{r}
data_F0V_multiple_final <- readRDS("data_F0V_multiple_final.RData")
data_F0V_final <- readRDS("data_F0V_final.RData")
...
F0V_intercept_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors,
    file = here("models", "F0V_intercept_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
F0_task_environment_language_age_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors1,
    file = here("models", "F0_task_environment_language_age_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
VSA_task_environment_language_age_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors1,
    file = here("models","VSA_task_environment_language_age_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
AR_task_environment_language_age_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors1,
    file = here("models", "AR_environment_language_age_m"),
    sample_prior = T,
    iter = 10000, 
    warmup = 500,
    cores = cores,
...
VD_task_environment_language_age_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors1,
    file = here("models", "VD_task_environment_language_age_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
F0V_task_environment_language_age_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors1,
    file = here("models", "F0V_task_environment_language_age_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
F0_task_language_age_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors1,
    file = here("models", "F0_task_language_age_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
VSA_task_language_age_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors1,
    file = here("models", "VSA_task_language_age_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
AR_task_language_age_m <- 
  brm(
    ...
    family = student,
    prior = priors1,
    file = here("models", "AR_task_language_age_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
VD_task_language_age_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors1,
    file = here("models", "VD_task_language_age_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
F0V_task_language_age_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors1,
    file = here("models", "F0V_task_language_age_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
F0_environment_language_age_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors1,
    file = here("models", "F0_environment_language_age_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
VSA_environment_language_age_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors1,
    file = here("models", "VSA_environment_language_age_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
VD_environment_language_age_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors1,
    file = here("models", "VD_environment_language_age_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
F0V_environment_language_age_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors1,
    file = here("models", "F0V_environment_language_age_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
F0_age_language_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors1,
    file = here("models", "F0_age_language_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
VSA_age_language_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors1,
    file = here("models", "VSA_age_language_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
AR_age_language_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors1,
    file = here("models", "AR_age_language_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
VD_age_language_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors1,
    file = here("models", "VD_age_language_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
F0V_age_language_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors1,
    file = here("models", "F0V_age_language_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
F0_language_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors2,
    file = here("models", "F0_language_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
VSA_language_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors2,
    file = here("models", "VSA_language_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
AR_language_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors2,
    file = here("models", "AR_language_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
VD_language_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors2,
    file = here("models", "VD_language_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
F0V_language_m <- 
  brm_multiple(
    ...
    family = student,
    prior = priors2,
    file = here("models", "F0V_language_m"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
F0_intercept_nonimputed <- 
  brm(
    ...
    family = student,
    prior = priors,
    file = here("models", "F0_intercept_nonimputed"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
VSA_intercept_nonimputed <- 
  brm(
    ...
    family = student,
    prior = priors,
    file = here("models", "VSA_intercept_nonimputed"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = 2,
...
AR_intercept_nonimputed <- 
  brm(
    ...
    family = student,
    prior = priors,
    file = here("models", "AR_intercept_nonimputed"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
VD_intercept_nonimputed <- 
  brm(
    ...
    family = student,
    prior = priors,
    file = here("models", "VD_intercept_nonimputed"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = 2,
...
F0V_intercept_nonimputed <- 
  brm(
    ...
    family = student,
    prior = priors,
    file = here("models", "F0V_intercept_nonimputed"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
F0_intercept_prior <- 
  brm(
    ...
    prior = priors,
    sample_prior = "only",
    file = here("models", "F0_intercept_prior"),
    #backend = "cmdstanr",
    #threads = threading(2),
    iter = 2000,
    warmup = 500,
...
VSA_intercept_prior <- 
  brm(
    ...
    prior = priors,
    sample_prior = "only",
    file = here("models", "VSA_intercept_prior"),
    #backend = "cmdstanr",
    #threads = threading(2),
    iter = 2000,
    warmup = 500,
...
AR_intercept_prior <- 
  brm(
    ...
    prior = priors,
    sample_prior = "only",
    file = here("models", "AR_intercept_prior"),
    #backend = "cmdstanr",
    #threads = threading(2),
    iter = 2000,
    warmup = 500,
...
VD_intercept_prior <- 
  brm(
    ...
    prior = priors,
    sample_prior = "only",
    file = here("models", "VD_intercept_prior"),
    #backend = "cmdstanr",
    #threads = threading(2),
    iter = 2000,
    warmup = 500,
...
F0V_intercept_prior <- 
  brm(
    ...
    prior = priors,
    sample_prior = "only",
    file = here("models", "F0V_intercept_prior"),
    #backend = "cmdstanr",
    #threads = threading(2),
    iter = 2000,
    warmup = 500,
...
F0_task_environment_language_age_report <- 
  brm(
    ...
    family = student,
    prior = priors1,
    file = here("models", "F0_task_environment_language_age_report"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
VSA_environment_report <- 
  brm(
    ...
    family = student,
    prior = priors1,
    file = "models/VSA_environment_report",
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
...
data_AR_final_report <- data_AR_final %>%
  select(Study, Language, Task, Environment, Age_months, Effect_Size, Effect_Size_se, measurement_num) %>%
  drop_na() %>%
  mutate(Age_months = center_scale(Age_months)) %>%
  mutate(Language = str_replace_all(Language, "[^[:alnum:]]", ""))
...
data_VD_final_report <- data_VD_final %>%
  select(Study, Language, Environment, Task, Age_months, Effect_Size, Effect_Size_se, measurement_num) %>%
  drop_na() %>%
  mutate(Age_months = center_scale(Age_months)) %>%
  mutate(Language = str_replace_all(Language, "[^[:alnum:]]", ""))
...
VD_age_language_report <- 
  brm(
    ...
    family = student,
    prior = priors1,
    file = here("models", "VD_age_language_report"),
    sample_prior = T,
    iter = 5000, 
    warmup = 500,
    cores = cores,
