...
Upon inspection, we can find that some models have different dimensions, because `VD_intercept` and `AR_task_environment_language_age` were run with 10,000 instead of 5,000 iterations (without further explanation).
```{r}
...
We therefore re-run these models with less iterations: 
